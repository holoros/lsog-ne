...
**Aaron R. Weiskittel**, University of Maine, Center for Research on Sustainable Forests, Orono, ME 04469. [co-authors TBD]

*Comment on Hagan, J.M., B. Shamgochian, M.M.L. Taylor & J.M. Reed. 2026. Using LiDAR to quantify, map, and conserve late-successional and old-growth forest in Maine, USA. Ecosphere 17:e70670. Ecosphere Comment format: no abstract; <= 16 manuscript pages.*
...
**Fig. 1.** Cross-map disagreement: (a) any-LSOG area by method (2.8-fold range); (b) the same 24 km window classified by each method; (c) only 21% of the flagged footprint is agreed by all three methods; (d) overlap of the top-priority protected hectares between maps (Jaccard 0.16-0.30).
...
All analyses, code, and derived products supporting this Comment are archived at Zenodo (concept DOI 10.5281/zenodo.20614496). Hagan et al.'s training data and code are at Zenodo 10.5281/zenodo.19696494. FIA data are from the USDA FIA DataMart (apps.fs.usda.gov/fia/datamart), accessed June 2026.

## Selected references

Birdsey, R. et al. 2025. [northeastern old-growth: aging gains vs harvest losses]. — *verify full citation.*
Box, G.E.P. 1976. Science and statistics. Journal of the American Statistical Association 71:791-799.
Hagan, J.M., B. Shamgochian, M.M.L. Taylor & J.M. Reed. 2026. Ecosphere 17:e70670.
Lang, N. et al. 2023. A high-resolution canopy height model of the Earth. Nature Ecology & Evolution. — *verify.*
Potapov, P. et al. 2021. Mapping global forest canopy height through GEDI and Landsat. Remote Sensing of Environment 253:112165.
Stanke, H. et al. 2020. rFIA: An R package for estimation of forest attributes with the FIA database. Environmental Modelling & Software 127:104664.
Thompson, J.R., A. Daigneault, J. Plisinski, I. Moon & J. Norton. 2026. Pathways for Protecting Maine's Remaining Late-Successional and Old-Growth Forests. Property and Environment Research Center.
